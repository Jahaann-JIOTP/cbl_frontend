...
const MeterDataComponent = () => {
  ...
  const getMapAreas = () => {
    switch (type) {
      case "volts":
        return [
          { coords: "690,280,790,200", href: `/log_detail2?meter=${meter}&val=volt&type=volts` },
          { coords: "690,330,790,410", href: `/log_detail2?meter=${meter}&val=current&type=current` },
          { coords: "690,550,790,470", href: `/log_detail2?meter=${meter}&val=power_factor&type=power_factor`},
          { coords: "1000,100,1250,35", href: `/sld_meters2?id=${id}&meter=${meter}` },
        ];
      case "power":
        return [
          { coords: "690,220,810,150", href: `/log_detail2?meter=${meter}&val=active_power&type=active_power` },
          { coords: "690,240,790,310", href: `/log_detail2?meter=${meter}&val=reactive_power&type=reactive_power` },
          { coords: "690,440,790,370", href: `/log_detail2?meter=${meter}&val=apparent_power&type=apparent_power` },
       // { coords: "690,600,790,460", href: `/log_detail2?meter=${meter}&val=harmonics&type=harmonics` },
          { coords: "1000,100,1250,35", href: `/sld_meters2?id=${id}&meter=${meter}` },
        ];
      case "energy":
        return [
          { coords: "690,280,790,200", href: `/log_detail2?meter=${meter}&val=active_energy&type=active_energy` },
          { coords: "690,420,790,350", href: `/log_detail2?meter=${meter}&val=reactive_energy&type=reactive_energy` },
          { coords: "690,580,790,480", href: `/log_detail2?meter=${meter}&val=apparent_energy&type=apparent_energy` },
          { coords: "1000,100,1250,35", href: `/sld_meters2?id=${id}&meter=${meter}` },
        ];
      default:
        return [];
