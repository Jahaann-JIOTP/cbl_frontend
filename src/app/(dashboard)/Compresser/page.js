...
function Page() {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch(
        "https://www.cblapi.jiotp.com/cbl_backend/diagram_data1.php"
      );
      if (!response.ok) {
  ...
  const meterMapping = {
    MainLine: {
      prefix: "F3_MainLine",
      position: { left: "79%", top: "20%" },
      lightPosition: { top: "25px", left: "-70px" }, // Customize for each meter
    },
    Sewing2: {
      prefix: "F4_Sewing2",
      position: { left: "74%", top: "65%" },
      lightPosition: { bottom: "420%", right: "102%" }, // Use percentages
    },
    Airjet: {
      prefix: "F2_Airjet",
      position: { left: "65%", top: "65%" },
      lightPosition: { bottom: "420%", right: "68%" }, // Use percentages
    },
    Sewing1: {
      prefix: "F7_PG",
      position: { left: "55%", top: "68%" },
      lightPosition: { bottom: "460%", right: "15%" }, // Use percentages
    },

    PG: {
      prefix: "F6_Sewing1",
      position: { left: "47%", top: "39.5%" },
      lightPosition: { top: "2px", left: "98%" },
    },
    GWP: {
      prefix: "F1_GWP",
      position: { left: "26%", top: "27%" },
      lightPosition: { top: "10px", left: "160px" },
    },
    Textile: {
      prefix: "F5_Textile",
      position: { left: "38%", top: "45%" },
      lightPosition: { top: "5px", left: "-68px" },
    },
  };
